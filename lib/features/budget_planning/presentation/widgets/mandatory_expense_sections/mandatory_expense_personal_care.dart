...
class MandatoryExpensePersonalCare extends StatelessWidget {
  const MandatoryExpensePersonalCare({
  ...
  Widget build(BuildContext context) {
    return MandatoryExpenseSection(
      title: AppLocalizations.of(context).categoryGroupExpensePersonalCare,
