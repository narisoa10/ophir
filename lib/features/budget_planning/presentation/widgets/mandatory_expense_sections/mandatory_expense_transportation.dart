...
class MandatoryExpenseTransportation extends StatelessWidget {
  const MandatoryExpenseTransportation({
  ...
  Widget build(BuildContext context) {
    return MandatoryExpenseSection(
      title: AppLocalizations.of(context).categoryGroupExpenseTransportation,
