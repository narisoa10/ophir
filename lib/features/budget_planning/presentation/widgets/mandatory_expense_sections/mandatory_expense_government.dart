...
class MandatoryExpenseGovernment extends StatelessWidget {
  const MandatoryExpenseGovernment({
  ...
  Widget build(BuildContext context) {
    return MandatoryExpenseSection(
      title: AppLocalizations.of(context).categoryGroupExpenseGovernment,
