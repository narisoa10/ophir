...
abstract final class AppTypography {
  ...
  static final TextStyle headingLg = screenTitle;
  ...
  static final TextStyle titleMd = sectionTitle;
  ...
  static final TextStyle bodySm = _base.copyWith(fontSize: 13, height: 1.4);

  static final TextStyle caption = _base.copyWith(fontSize: 13, height: 1.4);

  static final TextStyle captionLg = caption;

  static final TextStyle captionStrong = caption.copyWith(
    fontWeight: FontWeight.w600,
  );

  static final TextStyle labelLg = bodyStrong;
