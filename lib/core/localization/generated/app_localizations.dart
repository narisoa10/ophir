...
abstract class AppLocalizations {
  ...
  /// No description provided for @internalTransferReviewBanner.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{1 possible transfer to review} other{{count} possible transfers to review}}'**
  String internalTransferReviewBanner(int count);

  /// No description provided for @internalTransferReviewSheetTitle.
  ///
  /// In en, this message translates to:
  /// **'Possible transfers'**
  String get internalTransferReviewSheetTitle;

  /// No description provided for @internalTransferReviewFrom.
  ///
  /// In en, this message translates to:
  /// **'From'**
  String get internalTransferReviewFrom;

  /// No description provided for @internalTransferReviewTo.
  ///
  /// In en, this message translates to:
  /// **'To'**
  String get internalTransferReviewTo;

  /// No description provided for @internalTransferReviewConfirm.
  ///
  /// In en, this message translates to:
  /// **'Confirm transfer'**
  String get internalTransferReviewConfirm;

  /// No description provided for @internalTransferReviewExplanation.
  ///
  /// In en, this message translates to:
  /// **'After confirmation this will be treated as a transfer between your accounts, not income or expense.'**
  String get internalTransferReviewExplanation;

  /// No description provided for @internalTransferReviewClose.
  ///
  /// In en, this message translates to:
  /// **'Close'**
  String get internalTransferReviewClose;

  /// No description provided for @internalTransferReviewUnavailableAccount.
  ///
  /// In en, this message translates to:
  /// **'Unavailable account'**
  String get internalTransferReviewUnavailableAccount;

  /// No description provided for @internalTransferReviewOutgoingDate.
  ///
  /// In en, this message translates to:
  /// **'Outgoing date'**
  String get internalTransferReviewOutgoingDate;

  /// No description provided for @internalTransferReviewIncomingDate.
  ///
  /// In en, this message translates to:
  /// **'Incoming date'**
  String get internalTransferReviewIncomingDate;

  /// No description provided for @internalTransferReviewSourceOperations.
  ///
  /// In en, this message translates to:
  /// **'Related operations'**
  String get internalTransferReviewSourceOperations;

  /// No description provided for @internalTransferReviewConfirmed.
  ///
  /// In en, this message translates to:
  /// **'Transfer confirmed'**
  String get internalTransferReviewConfirmed;

  /// No description provided for @internalTransferReviewSuggestionOutdated.
  ///
  /// In en, this message translates to:
  /// **'This transfer suggestion is outdated. The list was refreshed.'**
  String get internalTransferReviewSuggestionOutdated;

  /// No description provided for @internalTransferReviewSuggestionUnavailable.
  ///
  /// In en, this message translates to:
  /// **'This transfer suggestion is no longer available.'**
  String get internalTransferReviewSuggestionUnavailable;

  /// No description provided for @internalTransferReviewRetry.
  ///
  /// In en, this message translates to:
  /// **'Something went wrong. Try again.'**
  String get internalTransferReviewRetry;

  /// No description provided for @internalTransferReviewBannerSemantics.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{1 possible transfer to review} other{{count} possible transfers to review}}'**
