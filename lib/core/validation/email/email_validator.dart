...
class EmailValidator {
  ...
  static final RegExp _validDomainCharsRegExp = RegExp(r'^[a-zA-Z0-9.-]+$');

  static final RegExp _topLevelDomainRegExp = RegExp(r'^[a-zA-Z]{2,24}$');

  static String normalizeEmail(String input) {
    return input.trim().toLowerCase();
  }

  static EmailValidationResult validate({required String input}) {
  ...
  static List<String> getDropdownSuggestions(String input) {
    ...
    final suggestions = <String>{...directMatches, ...fuzzyMatches}.toList();
